...
class OpenQueue
{
  ...
  private:
	...
	const Graph* graph;	// for debugging
};
...
{
  public:
	ClosedSet( const Graph* _graph )		{ this->graph = _graph; }
	~ClosedSet()	{}
...
MicroPather::MicroPather( const Graph* _graph, unsigned allocate, unsigned typicalAdjacent, bool cache )
