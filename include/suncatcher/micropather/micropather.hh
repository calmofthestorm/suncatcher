	...
	*/
	class Graph
	{
	  public:
		...
		*/
		virtual float LeastCostEstimate( void* stateStart, void* stateEnd ) const = 0;
		...
		*/	
		virtual void AdjacentCost( void* state, MP_VECTOR< micropather::StateCost > *adjacent ) const = 0;
		...
		*/
		virtual void  PrintStateInfo( void* state ) const = 0;
	};
	...
	*/
	class MicroPather
	{
	  ...
	  public:
		...
		*/
		MicroPather( const Graph* graph, unsigned allocate = 250, unsigned typicalAdjacent=6, bool cache=true );
		~MicroPather();
